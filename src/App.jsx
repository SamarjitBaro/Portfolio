...
function App() {
  ...
  useEffect(() => {
    // Only hide the preloader once the content is loaded
    if (isLoaded && preloaderRef.current) {
      preloaderRef.current.style.display = "none";
    }
  }, [isLoaded]);
  /////////      set is loaderrrrrrrrrrrrrrrrrrrrerererere
      ...
      <div>
        ...
        >
          <div className="bg-[#1F1F1F] px-6 py-[60px]  about  md:flex items-center flex-col top-0 h-[100%] w-[50%] right-0 hidden  absolute">
            ...
            <div className="px-[80px] z-20 mt-[20px]">
              <p className=" para">
                ...
                CSS, JavaScript, React-Redux, Tailwind CSS, AJAX, Git, Canvas
          ...
          <div className="relative  md:mt-3 h-screen md:h-[25vw] md:py-24 pt-[10vh] px-[55px] rounded md:bg-transparent bg-[#1F1F1F]">
            ...
            <p className="text-[#CDCDCD] block md:hidden mt-10">
              ...
              HTML, CSS, JavaScript, React-Redux, Tailwind CSS, AJAX, Git,
              Canvas and creative tools like GSAP, SwiperJS, and Framer Motion.
        ...
        <div className="flex bg-[#EAEAEA]  h-[230vh]">
          <Frame
            ...
            setIsLoader={setIsLoaded} ///////      set is loaderrrrrrrrrrrrrrrrrrrrerererere
          />
        </div>
